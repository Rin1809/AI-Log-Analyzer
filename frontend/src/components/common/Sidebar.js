...
const Logo = () => (
<svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="40px" height="40px"><g clip-path="url(#prefix__clip0_5_13)" fill-rule="evenodd" clip-rule="evenodd" fill="#000">
