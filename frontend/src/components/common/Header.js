...
const Logo = () => (
// // fix: Dùng 'currentColor' để SVG tự đổi màu theo theme
<svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="32px" height="32px"><g clip-path="url(#prefix__clip0_5_13)" fill-rule="evenodd" clip-rule="evenodd">
