...
def send_email(host_id, subject, body_html, smtp_config, recipient_emails_str, network_diagram_path=None, attachment_paths=None):
    ...
    try:
        ...
        logging.warning(f"[{host_id}] Khong tim thay file logo '{LOGO_FILE}'.")
